  ...
  <v-row class="profileBlock">
    <v-col cols="6" class="profilePicture">
      ...
      <v-btn
        ...
        @click="showPictureInput"
        class="modifyBtn"
        dark
        >Modifier la photo de profil</v-btn
      >
    </v-col>
    <v-col cols="6" class="cardBlock">
      <v-card elevation="6" outlined class="profileCard">
        <v-card-title> Votre profil </v-card-title>
          ...
          <div class="text-center">
            <v-chip class="ma-2" color="#091F43" dark>
              ...
              <div class="infoChip">
                ...
                <button
                  v-if="lastnameInput == false"
                  @click="showLastNameInput"
                  class="modifBtn"
                >
                  <v-icon class="modifIcon">mdi-pencil</v-icon>
                </button>
              </div>
            </v-chip>
          ...
          <div class="text-center">
            <v-chip class="ma-2" color="#091F43" dark>
              ...
              <div class="infoChip">
                ...
                <button
                  v-if="firstnameInput == false"
                  @click="showFirstNameInput"
                  class="modifBtn"
                >
                  <v-icon class="modifIcon">mdi-pencil</v-icon>
                </button>
          ...
          <div class="text-center">
            <v-chip class="ma-2 deleteColor" dark>
              <div class="infoChip">
                ...
                <button @click="deleteAccount" class="modifBtn">
                  <v-icon class="deleteIcon">mdi-delete-forever</v-icon>
                </button>
              </div>
            </v-chip>
          </div>
...
export default {
  ...
  methods: {
    ...
    deleteAccount() {
      axios
        .delete(
          "auth/users/" + JSON.parse(localStorage.getItem("userInfo")).id,
          {
            headers: {
    ...
    getProfile: function () {
      axios
        .get("auth/users/" + JSON.parse(localStorage.getItem("userInfo")).id, {
